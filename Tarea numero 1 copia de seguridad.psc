				...
				"2":
					...
					mientras decision="si" hacer 
						...
						Mientras contador<>limite2 hacer 
							contador=contador+1
							total1<-valor2*decision1
							escribir valor2,"x",contador,"=",total1
						FinMientras
						Escribir "¿desea continuar con la tabla de mientras?"
						leer decision
					FinMientras
			    "3":
					...
					repetir 
						...
						escribir "Quieres continuar con la tabla de repetir"
						leer decision2
		...
		"2":
			...
			repetir
				...
				sino
					...
					FinSi
				FinSi
				escribir "desea continuar con la calculadora"
				leer decision4
